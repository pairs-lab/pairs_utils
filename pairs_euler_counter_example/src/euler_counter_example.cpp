...
#include <pairs_euler_counter_example/pairs_euler_counter_exampleConfig.h>

#include <geometry_msgs/PoseStamped.h>

#include <eigen3/Eigen/Eigen>

namespace pairs_euler_counter_example
{
...
private:
  ...
  typedef pairs_euler_counter_example::pairs_euler_counter_exampleConfig DrsParams_t;
  typedef dynamic_reconfigure::Server<DrsParams_t>                   Drs_t;
  boost::shared_ptr<Drs_t>                                           drs_;
  void        callbackDrs(pairs_euler_counter_example::pairs_euler_counter_exampleConfig &params, uint32_t level);
  DrsParams_t params_;
...
void EulerCounterExample::callbackDrs(pairs_euler_counter_example::pairs_euler_counter_exampleConfig &params, [[maybe_unused]] uint32_t level) {
...
void EulerCounterExample::timerMain([[maybe_unused]] const ros::TimerEvent &event) {
...

  {
    ...
    thrust_pose.pose.orientation = pairs_lib::AttitudeConverter(R1);
  ...
  switch (params.type) {
    ...
    case 0: {
      ...
      auto [roll, pitch, yaw] = pairs_lib::AttitudeConverter(R1).getIntrinsicRPY();
      ...
      R1 = pairs_lib::AttitudeConverter(roll, pitch, yaw, pairs_lib::RPY_INTRINSIC);
    ...
    case 1: {
      ...
      auto [roll, pitch, yaw] = pairs_lib::AttitudeConverter(R1).getExtrinsicRPY();
      ...
      R1 = pairs_lib::AttitudeConverter(roll, pitch, yaw, pairs_lib::RPY_EXTRINSIC);
    ...
    case 4: {
      ...
      if (params.apply_angle) {
        R1 = pairs_lib::AttitudeConverter(R1).setHeading(params.angle);
      }
    ...
    case 5: {
      ...
      if (params.apply_angle) {
        ...
        double current_heading = pairs_lib::AttitudeConverter(R1).getHeading();
...
PLUGINLIB_EXPORT_CLASS(pairs_euler_counter_example::EulerCounterExample, nodelet::Nodelet)
