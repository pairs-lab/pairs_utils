...
void Throttle::onInit() {
  ...
  pairs_lib::ParamLoader param_loader(nh, "Throttle");
  ...
  sh_camera_info_ = pairs_lib::SubscribeHandler<sensor_msgs::CameraInfo>(shopts, "camera_info_in", &Throttle::callbackCameraInfo, this);
...
PLUGINLIB_EXPORT_CLASS(pairs_camera_republisher::Throttle, nodelet::Nodelet);
