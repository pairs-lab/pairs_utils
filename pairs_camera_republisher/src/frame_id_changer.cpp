...
namespace pairs_camera_republisher
{
...
private:
  ...
  pairs_lib::PublisherHandler<sensor_msgs::CameraInfo> ph_camera_info;
  ...
  pairs_lib::SubscribeHandler<sensor_msgs::CameraInfo> sh_camera_info_;
};
...
void FrameIdChanger::onInit() {
  ...
  pairs_lib::ParamLoader param_loader(nh, "FrameIdChanger");
  ...
  sh_camera_info_ = pairs_lib::SubscribeHandler<sensor_msgs::CameraInfo>(shopts, "camera_info_in", &FrameIdChanger::callbackCameraInfo, this);

  // | ----------------------- publishers ----------------------- |

  ph_camera_info = pairs_lib::PublisherHandler<sensor_msgs::CameraInfo>(nh, "camera_info_out", 1);
...
PLUGINLIB_EXPORT_CLASS(pairs_camera_republisher::FrameIdChanger, nodelet::Nodelet);
