...
***See also:** [PAIRS system's frames of reference documentation](https://ctu-pairs.github.io/docs/system/frames_of_reference.html) (with illustrations!)*
...
The roots of these trees are `uav1/fcu` and `uav2/fcu`, corresponding to the UAVs' Flight Control Units (as is typical in the [PAIRS system](https://ctu-pairs.github.io/docs/system/frames_of_reference.html)).
...
You can test this by spawning two UAVs in the [PAIRS simulation](https://github.com/ctu-pairs/pairs_simulation) called UAV1 and UAV2 and running `roslaunch pairs_tf_connector tf_connector.launch`.
