...
# dependency .debs from /prebuilt, then builds pairs_utils and copies the .deb to /output.
...
LOCAL_RULES="/src/pairs_utils/packaging/rosdep/pairs.yaml"
