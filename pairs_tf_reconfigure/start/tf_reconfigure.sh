...
"
  'TfReconfigure' "ros2 launch pairs_tf_reconfigure tf_reconfigure.launch.py
"
  'RVIZ' "cd $(ros2 pkg prefix --share pairs_tf_reconfigure); ros2 run rviz2 rviz2 -d rviz/tf_reconfigure.rviz
"
