...
input=(
  'Roscore' 'roscore
'
  'TfReconfigure' "waitForRos; roslaunch pairs_tf_reconfigure tf_reconfigure.launch
"
  'RVIZ' "waitForRos; roscd pairs_tf_reconfigure; rosrun rviz rviz -d rviz/tf_reconfigure.rviz
"
