...
namespace pairs_throw_activation
{
...
void ThrowActivation::onInit(void) {
  ...
  pairs_lib::ParamLoader param_loader(nh_, "ThrowActivation");
  ...
  sch_midair_activation_ = pairs_lib::ServiceClientHandler<std_srvs::Trigger>(nh_, "midair_activation_out");
...
PLUGINLIB_EXPORT_CLASS(pairs_throw_activation::ThrowActivation, nodelet::Nodelet)
